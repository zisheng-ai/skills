...
| Fiction H5 Builder | [`fiction-h5-builder`](./fiction-h5-builder) | `fiction-h5-builder` | 构建移动优先的小说阅读 H5 站点，支持多语言、多页面模板与 oh-story 数据接入 |
...
cp -R fiction-h5-builder ~/.claude/skills/fiction-h5-builder
...
cp -R fiction-h5-builder ~/.codex/skills/fiction-h5-builder
